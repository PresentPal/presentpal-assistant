window.categoryKeywords = {
  ...
  "💄 Health & Beauty": {
    "► All Health & Beauty": ["Health & Beauty", "Beauty", "Personal Care"],
    ...
    "Makeup": ["Makeup"],
    "Womens' Hair Care": ["Beauty, Hair care", "Women > Personal care > Hair care & styling >", "Men > Women > Personal care > Personal care > Personal Care > Hair care & styling", "shampoo", "conditioner", "hair mask", "leave-in conditioner", "hair serum", "dry shampoo", "hair treatment", "curl cream", "frizz control"],
    ...
    "Womens' Shaving & Hair Removal": ["Beauty, Shaving and hair removal", "shaving cream", "shaving gel", "razor", "wax strips", "epilator", "hair removal cream", "shaving kit", "hair removal device", "electrolysis"],
    ...
    "Shaving & Grooming": ["Men > Personal Care > Shaving & hair-cutting >", "Shaving & Grooming", "shaving cream", "aftershave", "razor", "beard trimmer", "shaving set", "shaving soap", "razor blade refills", "grooming kit", "beard oil", "beard balm"],
    "Mens' Body Wash & Shower Gel": ["Men > Personal Care > Hygiene", "mens body wash", "mens shower gel", "mens soap", "mens body scrub", "mens shower cream", "cleansing gel", "mens bath gel", "conditioner", "shampoo"],
    "Mens' Hair Care": ["Men > Personal Care > Hair care", "Men > Women > Personal care > Personal care > Personal Care > Hair care & styling", "shampoo", "hair gel", "pomade", "hair wax", "styling mousse", "hair cream", "beard shampoo", "anti-dandruff shampoo"],
    "Mens Fragrances": ["Men > Personal Care > Fragrances", "mens cologne", "mens perfume", "aftershave", "mens fragrance", "mens body spray", "cologne spray"],
    "Mens' Skin Care": ["Men > Personal Care > Skin care", "Men > Women > Personal care > Personal Care > Face & skin care", "face moisturiser", "face moisturizer", "anti-aging cream", "mens sunscreen", "beard balm", "mens face wash", "mens face scrub", "eye cream", "mens toner"],
  ...
  "🍽 Cooking & Kitchen": {
    ...
    "Tableware": ["Tableware", "Kitchen > Tableware & cutlery trays", "dinner plates", "cutlery set", "ceramic plates", "drinking glass", "utensils", "table runner", "placemats", "bowls"],
    "Coffee & Tea": ["Home > Coffee & tea", "coffee machine", "tea infuser", "coffee grinder", "coffee cups", "tea set", "coffee beans", "coffee filters", "tea leaves"],
    "Grill & Accessories": ["Kitchen > Grill & accessories", "Men > Accessories > Deals", "Men > Personal Care > Deals", "grill tools", "bbq grill", "grill set", "bbq accessories", "charcoal grill", "gas grill", "grill brush", "barbecue"],
    "Knives & Accessories": ["Kitchen > Knives & accessories", "chef knives", "cutlery set", "kitchen knives", "paring knives", "carving knives", "knife block set"],
    "Pans & Skillets": ["Kitchen > Pans & skillets", "frying pan", "non-stick pan", "cast iron skillet", "cooking pan", "skillet set", "wok pan"],
    "Appliances": ["Kitchen > Kitchen appliances", "Kitchen > Kitchen scales", "kitchen appliances", "small appliances", "coffee maker", "electric blender", "microwave", "toaster"],
    "Wine & Cocktails": ["Kitchen > Wine & cocktail", "wine glasses", "cocktail shaker", "wine opener", "barware", "cocktail glasses", "wine cooler", "cocktail recipes"]
  },
  "🍷 Vintage Wines": {
  "► All Wines": ["vintage wine", "wine collection", "fine wine", "aged wine", "luxury wine", "vintage port"]
},
  "🎮 Games": {
    "► All Games": ["Games", "Consoles", "Playstation", "Xbox", "Nintendo"],
    "Consoles": ["Consoles", "game console", "Playstation", "playstation", "Xbox", "xbox", "nintendo switch", "Nintendo", "nintendo", "handheld gaming console", "games"],
    "PlayStation": ["Playstation", "playstation", "PlayStation", "ps5", "ps4", "ps3", "ps2", "ps1"],
    "Xbox": ["Xbox", "xbox"],
    "PC Gaming": ["PC Gaming"],
    "Nintendo": ["Nintendo", "nintendo"],
    "Portable Gaming": ["Portable Gaming"],
    "Retro Gaming": ["Retro Gaming"],
    "Gaming Accessories": ["Console Accessories", "gaming controller", "gaming headset", "gaming mouse", "gaming keyboard", "gaming chair"],
  ...
  "🏠 Household": {
    ...
    "Cleaning Supplies": ["Cleaning Supplies", "Household > Cleaning", "cleaning products", "cleaning wipes", "disinfectants", "household cleaners", "floor cleaner", "multi-surface cleaner"],
    "Laundry": ["Laundry", "Household > Clean, iron & dry", "laundry detergent", "fabric softener", "dryer sheets", "laundry basket", "ironing board", "clothes hamper"],
    "Essential Oils": ["Essential Oils > All Products > Blending", "Gifts & Kits > Essential Oils > All Products", "lavendar essential oil", "peppermint essential oil", "essential oils kit", "aromatherapy oil", "essential oil diffuser"],
    "Home Security": ["Household > Home Security", "Home Security > Alarms", "security cameras", "alarm system", "security door lock", "smart doorbell", "motion sensors"],
    "Car & Bike": ["Household > Car & bike", "car accessories", "bike accessories", "car cleaning", "car seat covers", "bike helmet", "car battery"],
    "Toilet & Bathroom": ["Household > toilet and bathroom", "toilet brush", "bathroom accessories", "toilet paper holder", "bath towel", "shower head"],
    "Vacuum Cleaners": ["Household > Vacuum cleaners", "vacuum cleaner", "robot vacuum", "cordless vacuum", "vacuum accessories"]
  },
  "🚠 DIY & Renovations": {
    "► All DIY & Rennovations": ["DIY", "Tools", "Power Tools", "Drill", "Construction"],
    "Adhesives, Sealants & Fillers": ["Adhesives, Sealants & Fillers"],
    "Air Tools & Compressors": ["Air Tools & Compressors", "air compressor", "pneumatic tools", "impact wrench", "air hose", "air tool set"],
    "Hardware": ["DIY And Hardware", "Household & Hardware", "hardware tools", "screws", "bolts", "drill set", "measuring tape"],
    ...
    "Lighting & Torches": ["Lighting & Torches", "flashlights", "LED light bulbs", "outdoor lighting", "floor lamps", "table lamps"],
    "Machinery": ["Machinery >"],
  ...
  "🪺 Interior Decorating": {
    "► All Interior Decorating": ["Furniture", "Home Accessories", "Lighting"],
  ...
  "🌳 Garden": {
    ...
    "Garden Tools": ["Garden Tools", "Deals > Tools and garden appliances", "DIY and tools, Lawnmowers and outdoor electric tools", "garden shovel", "rake", "garden shears", "watering can", "garden gloves"],
    "Barbecuing": ["Outdoor > Barbecues", "barbecue grill", "charcoal grill", "grill tools", "bbq accessories", "bbq", "barbecue"],
    "Garden Games": ["Garden Games >", "Hula Hoops", "lawn darts", "croquet set", "garden games", "outdoor games", "frisbees"]
  },
  "🚗 Automotive": {
    "► All Automotive": ["Battery Care & Chargers", "Bodywork & Windscreen", "Car Care & Car Cleaning", "Clips, O Rings, Pins & Springs",
                        ...
                        "Lubrication & Drainage", "Luggage, Recovery & Towing", "Tarpaulins & Covers", "Vehicle Repairs & Servicing", "car accessories", "car care products", "automotive tools", "car cleaning kit", "car cleaning"],
    "Battery Care & Chargers": ["Battery Care & Chargers", "battery care", "car battery charger", "battery charger", "portable charger", "car jump starter"],
    "Bodywork & Windscreen": ["Bodywork & Windscreen", "bodywork & windscreen", "car body repair", "windscreen wipers", "car windscreen", "bodywork tools"],
    "Car Care & Car Cleaning": ["Car Care & Car Cleaning", "car care", "car cleaning", "car wash", "car wax", "car polishing", "interior car cleaner", "car detailing"],
    "Clips, O Rings, Pins & Springs": ["Clips, O Rings, Pins & Springs"],
    "Diagnostic & Electrics": ["Diagnostic & Electrics", "diagnostic & electrics", "car diagnostics", "car electrical tools", "car diagnostic scanner", "vehicle tester"],
    "Fluid Transfer": ["Fluid Transfer"],
    "Garage & Workshop": ["Garage & Workshop", "garage & workshop", "garage tools", "workshop tools", "tool storage", "mechanic tools"],
    "Jacks, Lifting Gear & Stands": ["Jacks, Lifting Gear & Stands", "lifting gear", "car jack", "lifting stand", "engine hoist", "hydraulic lift", "trolley jack"],
    "Lubrication & Drainage": ["Lubrication & Drainage"],
    "Luggage, Recovery & Towing": ["Luggage, Recovery & Towing", "luggage & recovery", "car towing", "car tow straps", "recovery kit", "luggage set", "tow bar"],
  ...
  "🏍 Motorcycles": {
    ...
    "Womens Motorcycle Clothing": ["Motorcycle Clothing > Ladies", "ladies motorcycle clothing", "ladies motorcycle jackets", "ladies motorcycle gear", "ladies leather jackets", "ladies motorcycle gloves"],
    "Mens Motorcycle Clothing": ["Motorcycle Clothing > Mens", "mens motorcycle clothing", "mens motorcycle jackets", "mens motorcycle gear", "men’s leather jackets", "mens motorcycle gloves"],
    "Helmets": ["Motorcycle Helmets", "helmets", "motorcycle helmets", "bicycle helmets", "safety helmets", "full face helmets"],
  ...
  "🏅 Sports & Outdoors": {
    ...
    "Basketball": ["Basketball Gear", "basketball", "basketball shoes", "basketball gear", "basketball hoops", "basketballs"],
    "Football": ["Folding Football Goals", "Football", "football", "soccer", "football shoes", "football boots", "football gear", "soccer balls"],
    "Swimming & Watersports": ["Outdoor > Swimming Pools", "Outdoor > Inflatable Kayaks", "Outdoor > Inflatable Loungers", "Outdoor > Inflatable Stand Up Paddle Boards", "swimming & watersports", "swimming gear", "water sports equipment", "snorkels", "swimming goggles", "surfboards"],
    "Golf": ["Golf", "golf", "golf clubs", "golf balls", "golf tees", "golf gloves", "golf bags"],
    "Fitness": ["Heart Rate Monitor", "Medicine Balls", "Ab Belts", "Ab Benches", "Ab Crunchers", "Ab Exercisers", "Ab Straps", "Ab Wheels", "Exercise Bikes", "Exercise Mats", "Fitness >", "Fitness Equipment >", "fitness", "fitness equipment", "gym equipment", "workout gear", "yoga mats", "fitness bands"]
  },
  "🎨 Arts & Crafts": {
    "► All Arts & Crafts": ["Craft", "Paint", "Drawing", "Creative"],
    "Pens & Paint": ["Pens, Paint and Colour"],
    "Crafts & Sewing": ["crafts & sewing", "craft supplies", "sewing kits", "sewing thread", "needles", "fabric", "embroidery kits"],
    "Die Cutting": ["Die Cutting"],
    "Stationery": ["Default Category>Peripherals>Office Supply>stationery & office supplies>"],
    "Pens & Pencils": ["Marabu", "pens & pencils", "ballpoint pens", "drawing pencils", "markers", "highlighters", "writing instruments"],
    "Mediums & Finishes": ["Mediums & Finishes", "mediums & finishes", "art mediums", "paint finishes", "varnish", "glaze", "art supplies"]
  },
  "🏢 Business": {
...
"🧩 Uncategorized": {
  "► All Uncategorized": ["Best Selling Products", "Clearance", "General"],
  "Best Selling Products": ["Best Selling Products"],
  "Clearance": ["Clearance"]
},
  "🌍 Travel": {
    "► All Travel": ["travel accessories", "travel bags", "luggage", "travel pillows", "travel gear", "luggage set"],
    "London Day Out": ["London"],
    "Luggage & Travel Gear": ["Luggage & Bags > Backpacks", "Luggage & Bags > Duffel Bags", "Luggage & Bags > Cosmetic & Toiletry Bags", "Default Category>Bags> Luggage & Travel Gear", "luggage & travel gear", "suitcases", "travel bags", "luggage sets", "backpacks", "travel duffel bag"],
    "Kids Travel Bottles": ["Men > Women > Children > Baby & children products > Training & fitness"],
    "Travel Accessories": ["Travel accessories", "travel accessories", "neck pillow", "eye mask", "luggage tags", "travel wallet", "portable charger"]
  }
};
